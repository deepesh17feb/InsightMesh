...
- **Execution Timestamp:** `2026-08-02T04:44:18.304296+00:00`
- **Trace URL:** https://us.cloud.langfuse.com/project/cmpwirpg5009oad0esljbiev9/traces/2f894bddcbde1149aede32dd0bb3402b
- **Run Mode:** `live_run`
...
```json
{
  ...
  "currency": "currency",
  "saved_method_type": "saved_method_type",
...
- **Documentation Gaps (10):** Undocumented column `app_version` in express_checkout; Undocumented column `client_lib` in express_checkout; Undocumented column `eligible` in express_checkout; Undocumented column `shown_amount` in express_checkout; Undocumented column `saved_method_type` in express_checkout; Undocumented column `otp_attempts` in express_checkout; Undocumented column `otp_success` in express_checkout; Undocumented column `payment_amount` in express_checkout; Undocumented column `payment_currency` in express_checkout; Undocumented column `payment_latency_ms` in express_checkout

---

## 6. Table Semantics (CUJ 1 → CUJ 2 Semantic Handoff)

- **Description:** A one-tap checkout for returning travellers. When a user with a saved payment
- **Concepts:** express checkout, event, id, device_type, os, app_version, geoip_country_code, city, client_lib
...
10. **context_agent::register_schema_version** (context_agent): registered table 'express_checkout' version 5 in schema_registry
...
12. **context_agent::write_table_semantics** (context_agent): wrote table description, concepts, and embedding (0 dims) for express_checkout into chDB table_semantics (v11)
